    ...
    internal class sqlLiteFunc : IDisposable
    {
        ...
        public void InsertMain(IList<FfprobeOutput> ffprobeOutputs, Settings settings)
        {
            ...
            var main = ffprobeOutputs.Where(x => x.MergeData is null).Select(x => new
            {
                ...
                x.MainData.idx,
                x.MainData.mergeIdx,
                x.MainData.timeConsuming,
                run = (int)x.MainData.run,
                x.MainData.videoType,
                x.MainData.audioMap,
                x.MainData.AudioCodec,
                x.MainData.AudionFormat,
                x.MainData.AudioSamplineRate,
            ...
            List<FfprobeOutput> ffprobes = [..
                ...
                select new FfprobeOutput
                {
                    MainData = new FfprobeOutputMain
                    {
                        ...
                        AudioCodec = ffprobeOutput.AudioCodec,
                        AudionFormat = ffprobeOutput.AudionFormat,
                        ...
                        timeConsuming = ffprobeOutput.timeConsuming,
